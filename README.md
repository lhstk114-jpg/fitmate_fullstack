...
| **연동 API** | ![OpenWeather API](https://img.shields.io/badge/-OpenWeather%20API-EB6E4B?style=flat) ![ExerciseDB API](https://img.shields.io/badge/-ExerciseDB%20API-4B0082?style=flat) ![Google Cloud Translation](https://img.shields.io/badge/-Google%20Cloud%20Translation-4285F4?logo=googlecloud&logoColor=white) ![KakaoBank API](https://img.shields.io/badge/-KakaoBank%20API-FFCD00?style=flat&logo=kakao&logoColor=black) ![KakaoMap API](https://img.shields.io/badge/-KakaoMap%20API-FFCD00?style=flat&logo=kakao&logoColor=black) |
