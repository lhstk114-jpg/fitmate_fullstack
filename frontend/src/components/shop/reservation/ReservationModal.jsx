...
import "../../../css/shop/reservation/reservationModal.css";

const ReservationModal = ({ setIsBool, modalMemberId }) => {
  const [memberData, setMemberData] = useState(null);
  const getMemberList = async () => {
    const url = `${API_SERVER_URL}/api/member/trainers/summary/${modalMemberId}`;
    try {
  ...
  return (
    <div className="reservationModal">
      <div className="reservationModal-con">
        ...
        <ul>
          <li>
            <h1>{memberData.userName} 트레이너님 상세정보</h1>
          </li>
          <li>
          ...
          <li>
            <span>전화번호</span>
            <span>{memberData.userPhone || "정보 없음"}</span>
          </li>
          <li>
            <span>관심사</span>
